...
exports.supportedMimeTypes = exports.supportedExtensions = exports.reasonableDetectionSizeInBytes = void 0;
...
var _index2 = require("../uint8array-extras/index.js");
...
const reasonableDetectionSizeInBytes = exports.reasonableDetectionSizeInBytes = 4100; // A fair amount of file-types are detectable within this range.
  ...
  async parse(tokenizer) {
        ...
        while (tokenizer.position + 30 < tokenizer.fileInfo.size) {
          ...
          if (zipHeader.compressedSize === 0) {
            ...
            while (nextHeaderIndex < 0 && tokenizer.position < tokenizer.fileInfo.size) {
              ...
              nextHeaderIndex = (0, _index2.indexOf)(this.buffer, new Uint8Array([0x50, 0x4B, 0x03, 0x04]));
    ...
    if (this.checkString('%PDF')) {
      try {
        ...
        if ((0, _index2.includes)(buffer, new TextEncoder().encode('AIPrivateData'))) {
          return {
            ext: 'ai',
            mime: 'application/postscript'
          };
    ...
    if (this.check([0x1A, 0x45, 0xDF, 0xA3])) {
      ...
      async function readElement() {
        ...
        return {
          id: (0, _index2.getUintBE)(idView),
          len: (0, _index2.getUintBE)(lengthView)
        };
      }
