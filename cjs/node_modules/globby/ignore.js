...
var _index = _interopRequireDefault(require("../fast-glob/out/index.js"));
var _index2 = _interopRequireDefault(require("../ignore/index.js"));
var _index3 = _interopRequireDefault(require("../slash/index.js"));
...
const parseIgnoreFile = (file, cwd) => {
  const base = (0, _index3.default)(_nodePath.default.relative(cwd, _nodePath.default.dirname(file.filePath)));
  return file.content.split(/\r?\n/).filter(line => line && !line.startsWith('#')).map(pattern => applyBaseToPattern(pattern, base));
};
const toRelativePath = (fileOrDirectory, cwd) => {
  cwd = (0, _index3.default)(cwd);
  if (_nodePath.default.isAbsolute(fileOrDirectory)) {
    if ((0, _index3.default)(fileOrDirectory).startsWith(cwd)) {
...
const getIsIgnoredPredicate = (files, cwd) => {
  ...
  const ignores = (0, _index2.default)().add(patterns);
  return fileOrDirectory => {
    fileOrDirectory = (0, _node.toPath)(fileOrDirectory);
    fileOrDirectory = toRelativePath(fileOrDirectory, cwd);
    return fileOrDirectory ? ignores.ignores((0, _index3.default)(fileOrDirectory)) : false;
  };
};
...
const isIgnoredByIgnoreFiles = async (patterns, options) => {
  ...
  const paths = await (0, _index.default)(patterns, {
    cwd,
    suppressErrors,
    deep,
    ignore,
...
const isIgnoredByIgnoreFilesSync = (patterns, options) => {
  ...
  const paths = _index.default.sync(patterns, {
    cwd,
    suppressErrors,
    deep,
    ignore,
