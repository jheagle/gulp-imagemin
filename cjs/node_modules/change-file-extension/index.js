...
exports.default = changeFileExtension;
...
function changeFileExtension(filePath, extension) {
  ...
  const basename = _nodePath.default.basename(filePath, _nodePath.default.extname(filePath));
  return _nodePath.default.join(_nodePath.default.dirname(filePath), basename + extension);
}