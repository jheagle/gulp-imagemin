...
class NumberPredicate extends _predicate.Predicate {
  /**
  @hidden
  */
  constructor(options) {
  ...
  */
  inRange(start, end) {
    return this.addValidator({
      ...
      validator: value => _index.default.inRange(value, [start, end])
    });
  }
  /**
  ...
  */
  get integer() {
    return this.addValidator({
      ...
      validator: value => _index.default.integer(value)
    });
  }
  /**
  ...
  */
  get finite() {
    return this.addValidator({
      ...
      validator: value => !_index.default.infinite(value)
    });
  }
  /**
  ...
  */
  get integerOrInfinite() {
    return this.addValidator({
      ...
      validator: value => _index.default.integer(value) || _index.default.infinite(value)
    });
  }
  /**
