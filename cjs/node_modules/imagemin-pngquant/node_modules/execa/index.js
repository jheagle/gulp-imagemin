...
const handleArguments = (file, args, options = {}) => {
  ...
  options = {
    ...
    all: false,
    windowsHide: true,
    verbose: _verbose.verboseDefault,
    ...options
  };
...
function execa(file, args, options) {
  ...
  (0, _verbose.logCommand)(escapedCommand, parsed.options);
  ...
  try {
    ...
    (0, _promise.mergePromise)(dummySpawned, errorPromise);
    return dummySpawned;
  }
  ...
  (0, _stream.handleInput)(spawned, parsed.options);
  spawned.all = (0, _stream.makeAllStream)(spawned, parsed.options);
  (0, _pipe.addPipeMethods)(spawned);
  (0, _promise.mergePromise)(spawned, handlePromiseOnce);
  return spawned;
}
function execaSync(file, args, options) {
  ...
  const escapedCommand = (0, _command.getEscapedCommand)(file, args);
  (0, _verbose.logCommand)(escapedCommand, parsed.options);
  const input = (0, _stream.handleInputSync)(parsed.options);
  let result;
  try {
    result = _nodeChild_process.default.spawnSync(parsed.file, parsed.args, {
      ...parsed.options,
      input
    });
  } catch (error) {
...
function create$(options) {
  function $(templatesOrOptions, ...expressions) {
    ...
    const [file, ...args] = (0, _command.parseTemplates)(templatesOrOptions, expressions);
  ...
  $.sync = (templates, ...expressions) => {
    ...
    const [file, ...args] = (0, _command.parseTemplates)(templates, expressions);
