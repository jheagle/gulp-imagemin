...
class ReadStreamTokenizer extends _AbstractTokenizer.AbstractTokenizer {
  constructor(stream, fileInfo) {
    super(fileInfo);
    this.streamReader = new _index.StreamReader(stream);
  }
  /**
  ...
  async peekBuffer(uint8Array, options) {
    ...
    if (normOptions.length > 0) {
      try {
        ...
        if (options && options.mayBeLess && err instanceof _index.EndOfStreamError) {
          return 0;
        }
        throw err;
      }
