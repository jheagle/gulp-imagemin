...
class ArrayPredicate extends _predicate.Predicate {
  /**
  @hidden
  */
  constructor(options) {
  ...
  */
  deepEqual(expected) {
    return this.addValidator({
      ...
      validator: value => (0, _index.deepEqual)(value, expected)
    });
  }
  /**
  ...
  */
  ofType(predicate) {
    ...
    return this.addValidator({
      ...
      validator: value => (0, _ofType.default)(value, 'values', predicate)
    });
  }
  /**
  ...
  */
  exactShape(predicates) {
    ...
    return this.addValidator({
      ...
      validator: object => (0, _matchShape.exact)(object, shape, undefined, true)
    });
  }
}
