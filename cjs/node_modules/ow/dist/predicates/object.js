...
var _index2 = require("../../../dot-prop/index.js");
var _index3 = require("../../../fast-equals/dist/cjs/index.cjs");
...
var _ofTypeDeep = _interopRequireDefault(require("../utils/of-type-deep.js"));
var _matchShape = require("../utils/match-shape.js");
var _predicate = require("./predicate.js");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
class ObjectPredicate extends _predicate.Predicate {
  /**
  @hidden
  */
  constructor(options) {
  ...
  */
  get plain() {
    return this.addValidator({
      ...
      validator: object => _index.default.plainObject(object)
    });
  }
  /**
  ...
  */
  valuesOfType(predicate) {
    return this.addValidator({
      ...
      validator: object => (0, _ofType.default)(Object.values(object), 'values', predicate)
    });
  }
  /**
  ...
  */
  deepValuesOfType(predicate) {
    return this.addValidator({
      message: (_, label, error) => `(${label}) ${error}`,
      validator: object => (0, _ofTypeDeep.default)(object, predicate)
    });
  }
  /**
  ...
  */
  deepEqual(expected) {
    return this.addValidator({
      ...
      validator: object => (0, _index3.deepEqual)(object, expected)
    });
  }
  /**
  ...
  */
  hasKeys(...keys) {
    return this.addValidator({
      ...
      validator: object => (0, _hasItems.default)({
        has: item => (0, _index2.hasProperty)(object, item)
      }, keys)
    });
  }
  /**
  ...
  */
  hasAnyKeys(...keys) {
    return this.addValidator({
      ...
      validator: object => keys.some(key => (0, _index2.hasProperty)(object, key))
    });
  }
  /**
  ...
  */
  partialShape(shape) {
    return this.addValidator({
      ...
      validator: object => (0, _matchShape.partial)(object, shape)
    });
  }
  /**
  ...
  */
  exactShape(shape) {
    ...
    return this.addValidator({
      ...
      // eslint-disable-next-line @typescript-eslint/no-unsafe-call
      message: (_, label, message) => `${message.replace('Expected', 'Expected property')} in ${label}`,
      validator: object => (0, _matchShape.exact)(object, shape)
    });
  }
}
