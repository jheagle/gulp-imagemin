...
class StringPredicate extends _predicate.Predicate {
  /**
  @hidden
  */
  constructor(options) {
  ...
  get nonBlank() {
    return this.addValidator({
      message(value, label) {
        ...
        const madeVisible = value.replaceAll(' ', '·').replaceAll('\f', '\\f').replaceAll('\n', '\\n').replaceAll('\r', '\\r').replaceAll('\t', '\\t').replaceAll('\v', '\\v');
  ...
  */
  get date() {
    return this.addValidator({
      ...
      validator: value => _index.default.validDate(new Date(value))
    });
  }
  /**
  ...
  */
  get url() {
    return this.addValidator({
      ...
      validator: _index.default.urlString
    });
  }
}
