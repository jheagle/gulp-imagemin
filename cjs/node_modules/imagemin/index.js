...
var _index0 = require("../image-dimensions/index.js");
...
const handleFile = async (sourcePath, {
  ...
  const dimensions = (0, _index0.imageDimensionsFromData)(data);
  ...
  destinationPath = ext === 'webp' && destinationPath ? (0, _index4.default)(destinationPath, 'webp') : destinationPath;
  const returnValue = {
