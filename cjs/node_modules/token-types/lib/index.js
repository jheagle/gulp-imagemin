...
class BufferType {
  ...
  get(uint8Array, off) {
    return _nodeBuffer.Buffer.from(uint8Array.subarray(off, off + this.len));
  }
}
/**
...
class StringType {
  ...
  get(uint8Array, offset) {
    return _nodeBuffer.Buffer.from(uint8Array).toString(this.encoding, offset, offset + this.len);
  }
}
/**
 * ANSI Latin 1 String
