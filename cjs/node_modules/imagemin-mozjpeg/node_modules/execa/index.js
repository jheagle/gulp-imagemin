...
var _index = _interopRequireDefault(require("../../../cross-spawn/index.js"));
var _index2 = _interopRequireDefault(require("../strip-final-newline/index.js"));
var _index3 = require("../npm-run-path/index.js");
var _index4 = _interopRequireDefault(require("../onetime/index.js"));
...
const getEnv = ({
  ...
  if (preferLocal) {
    return (0, _index3.npmRunPathEnv)({
      env,
      cwd: localDir,
      execPath
    });
...
const handleArguments = (file, args, options = {}) => {
  const parsed = _index.default._parse(file, args, options);
  file = parsed.command;
  args = parsed.args;
...
const handleOutput = (options, value, error) => {
  ...
  if (options.stripFinalNewline) {
    return (0, _index2.default)(value);
  }
  return value;
};
function execa(file, args, options) {
  ...
  const handlePromiseOnce = (0, _index4.default)(handlePromise);
