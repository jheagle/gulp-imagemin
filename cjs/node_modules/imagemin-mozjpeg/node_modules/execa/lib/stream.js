...
var _index2 = _interopRequireDefault(require("../../get-stream/index.js"));
var _index3 = _interopRequireDefault(require("../../../../merge-stream/index.js"));
...
const getStreamPromise = (stream, {
  ...
  return _index2.default.buffer(stream, {
    maxBuffer
  });
};
